...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return array_merge(
            $this->getProductRules($hasActiveVariants, $productId),
    ...
    protected function getProductRules(bool $hasActiveVariants, ?int $productId): array
    {
        return [
            ...
            'create_redirect_on_slug_change' => ['nullable', 'boolean'],
