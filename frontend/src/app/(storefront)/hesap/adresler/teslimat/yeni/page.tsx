...
export default function NewShippingAddressPage() {
  ...
  return (
    <AccountShell
      title={<T k="storefront.account.address.shipping_new_title" fallback="Yeni teslimat adresi" />}
      subtitle={<T k="storefront.account.address.shipping_new_subtitle" fallback="Yeni bir teslimat adresi ekleyin." />}
    >
      {error ? (
      ...
      <AddressForm variant="shipping" onSubmit={handleSubmit} submitting={saving} />
    </AccountShell>
  );
}
